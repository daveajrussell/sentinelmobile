...
public class HistoricalGeospatialDataSetAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    static {
        METHOD_NAME = "/PostHistoricalData";
        URL = "http://webservices.daveajrussell.com/Services/LocationService.svc";
    }

    public HistoricalGeospatialDataSetAsyncTask(Context context) {
